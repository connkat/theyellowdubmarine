...
export default function Home() {
  return (
    <div
      ...
      style={{ backgroundImage: `url(${water2.src})` }}
    >
      <div className="wordart">
        <h1>The Yellow Dubmarine!!!!</h1>
      </div>
      <Card>
        <img src={yellowRV.src} alt="RV" className="rv max-w-full pt-[5vh]" style={{ maxWidth: 200 }} />
        ...
        <div className="pb-4 flex flex-col items-center">
          <p className="warning-text pt-[2vh] text-sm md:text-base">
            <img src={no.src} alt="NO" className="inline max-w-[1vh] md:max-w-[2vh]" />
